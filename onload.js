window.onload = function() {
  ...
  document.getElementById('note.com.frame').insertAdjacentHTML('beforeend', '<iframe src="https://pannyaa.github.io/rss/" width="500" height="600" frameborder="0" target="_blank" rel="noreferrer noopener"></iframe>');
};